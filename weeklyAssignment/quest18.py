# Write a program for a number guessing game where the computer randomly selects a number between 1 and 100, and 
# the user tries to guess it. The program should give hints if the guess is too high or too low.
